...
if(changed&&w.func){var _t=this;w.func.call(_t,w,i);}}};$.fn.unwatch=function(id){this.each(function(){var w=$(this).data(id);var el=$(this);el.removeData();if(typeof(this.onpropertychange)=='object')
