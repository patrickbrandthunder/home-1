...
//die();
$baseURL = 'http://brandthunder_cps.cps.ampfeed.com/suggestions?partner=brandthunder_cps&sub1=newtabgallery&v=1.1&results-os=8&results-ps=1&ip='.get_client_ip_server().'&ua='.urlencode($_SERVER['HTTP_USER_AGENT']).'&rfr='.urlencode('https://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
echo(file_get_contents($baseURL.'&qt='.urlencode($_GET['q'])));
?>
